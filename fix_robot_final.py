...
# The corrected XML with <limits> and proper <look> tags
...
# Path to the target file (in the INSTALL directory for immediate effect)
target_path = os.path.expanduser("~/ros2_ws/install/stonefish_bluerov2/share/stonefish_bluerov2/scenarios/bluerov2.scn")
