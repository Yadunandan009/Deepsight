...
target_path = os.path.expanduser("~/ros2_ws/src/stonefish_bluerov2/scenarios/bluerov2_tank.scn")

# Write the file
try:
    with open(target_path, "w") as f:
        f.write(xml_content)
    print(f"SUCCESS: Wrote corrected Tank XML to {target_path}")
