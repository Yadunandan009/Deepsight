...
# 1. THE ROBOT FILE (With the missing <limits> and <look> tags)
...
# 2. THE TANK FILE (With the missing <look name="sand">)
...
# Force overwrite the INSTALL path files directly
path_install_robot = os.path.expanduser("~/ros2_ws/install/stonefish_bluerov2/share/stonefish_bluerov2/scenarios/bluerov2.scn")
path_install_tank = os.path.expanduser("~/ros2_ws/install/stonefish_bluerov2/share/stonefish_bluerov2/scenarios/bluerov2_tank.scn")

try:
    with open(path_install_robot, "w") as f:
        f.write(robot_xml)
    print(f"SUCCESS: Force updated install Robot file: {path_install_robot}")

    with open(path_install_tank, "w") as f:
        f.write(tank_xml)
    print(f"SUCCESS: Force updated install Tank file: {path_install_tank}")
