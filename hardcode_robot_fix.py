...
# XML with HARDCODED position (No more variables)
...
<scenario>
    ...
    <robot name="bluerov2" fixed="false" self_collisions="false">
        ...
        <sensor name="dvl" type="dvl" rate="5.0">
            ...
            <ros_publisher topic="/bluerov2/dvl_sim" altitude_topic="/bluerov2/altitude"/>
        </sensor>
        ...
        <sensor name="camera_front" type="camera" rate="10.0">
            ...
            <ros_publisher topic="/bluerov2/camera"/>
        </sensor>
        ...
        <sensor name="multibeam" rate="10.0" type="multibeam">
            ...
            <link name="base_link"/>
            <ros_publisher topic="/bluerov2/multibeam"/>
        </sensor>

        <world_transform xyz="0.0 0.0 1.0" rpy="0.0 0.0 0.0"/>
        
        <ros_subscriber thrusters="/bluerov2/setpoint/pwm"/>
    </robot>
</scenario>
"""

# Overwrite the INSTALL file directly
path_install = os.path.expanduser("~/ros2_ws/install/stonefish_bluerov2/share/stonefish_bluerov2/scenarios/bluerov2.scn")

try:
    with open(path_install, "w") as f:
        f.write(robot_xml)
    print(f"SUCCESS: Wrote hardcoded robot file to {path_install}")
