...
<scenario>
    ...
    <robot name="$(arg vehicle_name)" fixed="false" self_collisions="false">
        <base_link name="base_link" type="compound" physics="submerged">
            ...
            <internal_part name="FoamBackLeft" type="box" physics="submerged" buoyant="true">
            ...
            <internal_part name="FoamBackRight" type="box" physics="submerged" buoyant="true">
                <dimensions xyz="0.2 0.15 0.091"/>
                <origin xyz="0.0 0.0 0.0" rpy="0.0 0.0 0.0"/>
                <material name="Neutral"/>
                <look name="blue"/>
            ...
            <internal_part name="FoamFrontLeft" type="box" physics="submerged" buoyant="true">
                <dimensions xyz="0.2 0.15 0.091"/>
                <origin xyz="0.0 0.0 0.0" rpy="0.0 0.0 0.0"/>
                <material name="Neutral"/>
                <look name="blue"/>
            ...
            <internal_part name="FoamFrontRight" type="box" physics="submerged" buoyant="true">
                <dimensions xyz="0.2 0.15 0.091"/>
                <origin xyz="0.0 0.0 0.0" rpy="0.0 0.0 0.0"/>
                <material name="Neutral"/>
                <look name="blue"/>
...
# Force overwrite the INSTALL path files directly to ensure the simulator picks it up
path_install_robot = os.path.expanduser("~/ros2_ws/install/stonefish_bluerov2/share/stonefish_bluerov2/scenarios/bluerov2.scn")

try:
    with open(path_install_robot, "w") as f:
        f.write(robot_xml)
    print(f"SUCCESS: Force updated install Robot file with RENAMED foam parts: {path_install_robot}")
